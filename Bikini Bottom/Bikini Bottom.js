class BikiniBottom
{
    ...
    constructor(){
        ...
        BABYLON.SceneLoader.ImportMeshAsync("", "resto/", "burger.babylon", this.scene).then((newMeshes) => {
            ...
            let burger1 = new Ennemi(burger, new BABYLON.Vector3(0, 0.75, 0), 0, [[60, 180], [120, 180]], 0.1, this.scene);
            ...
            let burger4 = new Ennemi(burger.createInstance("burger4"), new BABYLON.Vector3(-27, 0.75, -24), 250, [[90, 180], [180, 180]], 0.1, this.scene);
            ...
            let burger7 = new Ennemi(burger.createInstance("burger7"), new BABYLON.Vector3(-41, 0.75, 1), 205, [[120, 180], [240, 180]], 0.1, this.scene);
            let burger8 = new Ennemi(burger.createInstance("burger8"), new BABYLON.Vector3(-41, 0.75, 1), 205, [[120, 180], [240, 180]], 0.1, this.scene);
